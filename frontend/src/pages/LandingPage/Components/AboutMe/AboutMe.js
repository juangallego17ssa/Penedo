...
const AboutMeBox = () => {
    ...
    return(
        <AboutMe>
            ...
            <div className="divAboutTop">
                ...
                <div className="divTextContent">Hi, my name is Juan, born in Brazil and grew up in Europe. 
    ...
    I lived many years in Europe and worked as business consultant and Financial manager. After my last trip to Brazil I realised that I want to make possible people to come and discover Brazil, respecting the european perspective, helping local population and creating a positive impact in general.         </div>
            </div>
            <div className="divAboutRight"></div>
